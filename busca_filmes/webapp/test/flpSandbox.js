		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#buscafilmesbuscafilmes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"buscafilmesbuscafilmes-display": {
								"semanticObject": "buscafilmesbuscafilmes",
								"action": "display",
								"description": "Aplicação de busca de filmes por API",
								"title": "Catálogo de Filmes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=buscafilmes.buscafilmes",
									"url": sap.ui.require.toUrl("buscafilmes/buscafilmes")
								}
							}
						}
					}
